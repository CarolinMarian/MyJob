...
public class BewerbungReport extends ShowDefinition {
	...
	protected String getHeadlineText() {
		return "Report fuer alle Bewerbungen";
	}
	...
	protected void run() {
		...
		verwaltung.showBewerbungen(benutzer.getId(), new BewerbungCallback(this));
	...
	class BewerbungCallback implements AsyncCallback<Vector<Stellenausschreibung>> {

		private ShowDefinition showdef = null;

		public BewerbungCallback(ShowDefinition s) {
			this.showdef = s;
		}
		...
		public void onSuccess(Vector<Stellenausschreibung> stelle) {
			...
			if (stelle != null) {
				...
				reportVerwaltung.createAllInhalteOfBewerbungReport(benutzer, stelle,
						new AllInhalteOfBewerbungReportCallback(this.showdef));
			}
		}
	}
	...
	class AllInhalteOfBewerbungReportCallback implements AsyncCallback<AllInhalteOfBewerbungReport> {
		private ShowDefinition showdef = null;

		public AllInhalteOfBewerbungReportCallback(ShowDefinition s) {
			this.showdef = s;
		}
		...
		@Override
		public void onSuccess(AllInhalteOfBewerbungReport result) {
			if (result != null) {
